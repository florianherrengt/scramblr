...
context('Smoke tests', () => {
    ...
    it('set aes passphrase', function() {
        ...
        cy.get('.AesPassphraseForm_Button_Submit')
            .click()
            .should(() => {
                expect(
    ...
    it('delete a note', function() {
        ...
        cy.get('.NoteList .NoteCard')
            .first()
            .find('.NoteCard_IconButton_MoreActions')
            .click();
    ...
    it('edit a note', function() {
        ...
        cy.get('.NoteList .NoteCard')
            ...
            .find('.NoteCard_IconButton_MoreActions')
            .click();
        cy.get('.NoteCard_MenuItem_Edit')
            .last()
            .click();

        cy.get('.NoteList .CreateNote .CreateNote_TextField_Text')
            .type('edited')
            .type('{alt}{enter}');
        cy.get('.NoteList .NoteCard')
            .first()
    ...
    it('logout', function() {
        ...
        cy.url()
            .should('include', config.routerUri.signIn)
            .should(() => {
                expect(
                    localStorage.getItem(config.localStorageKeys.aesPassphrase),
                ).to.be.null;
